 ...
 * [$this.postFinish points at the ($this.leftLength + $this.rightLength + 2)-th 
 *  node in that singly linked list]  and
...
public class List2a<T> extends ListSecondary<T> {
    ...
    public final void moveToFinish() {
        this.moveToStart();
        // This is O(n), which is slower than the O(1) algorithm in List2
