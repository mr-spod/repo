...
public final class Statement1Parse1 extends Statement1 {
    ...
    private static void parseIf(Queue<String> tokens, Statement s) {
        ...
        Reporter.assertElseFatalError(Tokenizer.isCondition(tokens.front()),
                "IF statements must begin with a valid condition.");
        Condition c = parseCondition(tokens.dequeue());
        Reporter.assertElseFatalError(tokens.dequeue().equals("THEN"),
                "The condition of the IF statement must be followed by the keyword 'THEN'");
    ...
    private static void parseWhile(Queue<String> tokens, Statement s) {
        ...
        tokens.dequeue();
        Reporter.assertElseFatalError(Tokenizer.isCondition(tokens.front()),
                "WHILE statements must begin with a valid condition.");
        Condition c = parseCondition(tokens.dequeue());
        Reporter.assertElseFatalError(tokens.dequeue().equals("DO"),
                "The condition of the WHILE statement must be followed by the keyword 'DO'");
