        ...
        if (array.length() > 1) {
        	// assigning indexes to variables
        		...
        		if (leftIndex <= last) {
        			...
        			if (array.entry(top) >= array.entry(smallerIndex)) {
                		...
                		siftDown(array, smallerIndex, last);
        			}
        		}
        }
    }
...
//        BinaryTree<Integer> b = new BinaryTreeUtility.treeFromString("()");/
