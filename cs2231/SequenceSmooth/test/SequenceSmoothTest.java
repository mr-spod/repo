...
public final class SequenceSmoothTest {
    ...
    /**
     * Test smooth with s1 = <1073741825, 1073741825>.
     */
    @Test
    public void testA() {
        /*
    ...
    public void test4() {
         ...
         * Set up variables and call method under test
         */
        Sequence<Integer> seq1 = this.createFromArgs(7, 4);
        Sequence<Integer> expectedSeq1 = this.createFromArgs(7, 4);
        Sequence<Integer> seq2 = this.createFromArgs();
        Sequence<Integer> expectedSeq2 = this.createFromArgs(5);
        seq2 = SequenceSmooth.smooth(seq1);
        /*
         * Assert that values of variables match expectations
         */
    ...
    public void test5() {
         ...
         * Set up variables and call method under test
         */
        Sequence<Integer> seq1 = this.createFromArgs(1000, 4, 7);
        Sequence<Integer> expectedSeq1 = this.createFromArgs(1000, 4, 7);
        Sequence<Integer> seq2 = this.createFromArgs(13, 17, 11, 15, 23);
        Sequence<Integer> expectedSeq2 = this.createFromArgs(502, 5);
        seq2 = SequenceSmooth.smooth(seq1);
        /*
         * Assert that values of variables match expectations
         */
    ...
    public void test6() {
         ...
         * Set up variables and call method under test
         */
        Sequence<Integer> seq1 = this.createFromArgs(-1001, 4, -7);
        Sequence<Integer> expectedSeq1 = this.createFromArgs(-1001, 4, -7);
        Sequence<Integer> seq2 = this.createFromArgs(13, 17, 11, 15, 23);
        Sequence<Integer> expectedSeq2 = this.createFromArgs(-498, -1);
        seq2 = SequenceSmooth.smooth(seq1);
        /*
         * Assert that values of variables match expectations
         */
    ...
    public void test7() {
         ...
         * Set up variables and call method under test
         */
        Sequence<Integer> seq1 = this.createFromArgs(5, 7);
        Sequence<Integer> expectedSeq1 = this.createFromArgs(5, 7);
        Sequence<Integer> seq2 = this.createFromArgs(13, 17, 11, 15, 23);
