...
public class Program2 extends ProgramSecondary {
    ...
    public final String replaceName(String n) {
        ...
        // assigning this.name to replacedName
        String replacedName = this.name;
        // replacing this.name with n
        this.name = n;
    ...
    public final Map<String, Statement> replaceContext(
        ...
        // assigning this.context to a Map
        Map<String, Statement> replacedContext = this.context;
        // creating a new instance for this.context
        this.context = c.newInstance();
        // while the size of the Map c is more than 0
        while (c.size() > 0) {
            // remove nay pair and assign it to p
            Map.Pair<String, Statement> p = c.removeAny();
            // ass pair to this.context
            this.context.add(p.key(), p.value());
        }
    ...
    public final Statement newBody() {
        ...
        // returns a new instance of this.body
    ...
    public final Statement replaceBody(Statement b) {
        ...
        // assigning this.body to replaceBody
        Statement replacedBody = this.body;
        // replacing this.body with b
        this.body = b;
