...
public class Statement2 extends StatementSecondary {
    ...
    private void createNewRep() {
    		...
    		// Create root node of this.rep tree
        StatementLabel root = new StatementLabel(Kind.BLOCK);
        // Create sequence to represent child nodes of this.rep tree
        Sequence<Tree<StatementLabel>> children = new Sequence3<Tree<StatementLabel>>();
        // Assign an empty tree to this.rep
    ...
    public final void addToBlock(int pos, Statement s) {
        ...
        // Cast s to a Statement2 object
        Statement2 localS = (Statement2) s;
        
        // Create root & child variables for this.rep
        Sequence<Tree<StatementLabel>> children = this.rep.newSequenceOfTree();
        StatementLabel root = new StatementLabel(Kind.BLOCK);
        
        // Disassemble into those variables if there are 1 or more nodes in this.rep
        if (this.rep.size() > 0) {
             root = this.rep.disassemble(children);
        }
        
        // Insert the tree representing the given statement into children sequence
    ...
    public final Statement removeFromBlock(int pos) {
        ...
        // Remove tree at given position and assign it to s
    ...
    public final int lengthOfBlock() {
        ...
        // Length of block is the number of entries in sequence 'children'
    ...
    public final void assembleIf(Condition c, Statement s) {
        ...
        // Create statement label for an IF statement w/ given condition
        StatementLabel label = new StatementLabel(Kind.IF, c);
        
        // Make a sequence of trees and insert the representation of localS
        Sequence<Tree<StatementLabel>> children = this.rep.newSequenceOfTree();
