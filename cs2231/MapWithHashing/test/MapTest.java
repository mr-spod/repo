...
public abstract class MapTest {
    ...
    @Test
    public final void testArgumentConstructorOne() {
        Map<String, String> s = this.createFromArgsTest();
        s.add("JS", "1");
    ...
    @Test
    public final void testArgumentConstructorMany() {
        Map<String, String> s = this.createFromArgsRef();
        s.add("JS", "1");
        s.add("Sean", "2");
        s.add("Dave", "3");
        Map<String, String> sExpected = this.createFromArgsRef("JS", "1", "Sean", "2", "Dave", "3");
    ...
    @Test
    public final void testNonEmptySizeOneConstructed() {
        Map<String, String> s = this.createFromArgsTest("JS", "1");
        int sizeExpected = 1;

        assertEquals(s.size(), sizeExpected);
    }
    
    @Test
    public final void testNonEmptySizeOneAddeded() {
        Map<String, String> s = this.createFromArgsTest();
        s.add("JS", "1");
        Map<String, String> sExpected = this.createFromArgsRef("JS", "1");
    ...
    @Test
    public final void testNonEmptySizeManyConstructed() {
        Map<String, String> s = this.createFromArgsRef("JS", "1", "Sean", "2", "Dave", "3");
        int sizeExpected = 3;
    ...
    @Test
    public final void testNonEmptySizeManyAdded() {
        Map<String, String> s = this.createFromArgsRef();
        s.add("JS", "1");
        s.add("Sean", "2");
        s.add("Dave", "3");
    ...
    @Test
    public final void removeFromExistingMap() {
        Map<String, String> s = this.createFromArgsTest("JS", "1", "Sean", "2");
        s.remove("JS");
        Map<String, String> sExpected = this.createFromArgsRef("Sean", "2");

        assertEquals(s, sExpected);
    }
    
    @Test
    public final void removeFromExistingMapEmpty() {
        Map<String, String> s = this.createFromArgsTest("JS", "1");
        s.remove("JS");
        Map<String, String> sExpected = this.createFromArgsRef();
